...
class LahanParkir {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " (nomor_lahan_parkir, id_penghuni, harga_lahan_parkir, jenis_lahan_parkir, status) VALUES (:nomor_lahan_parkir, :id_penghuni, :harga_lahan_parkir, :jenis_lahan_parkir, :status)";
    ...
    public function update() {
        $query = "UPDATE " . $this->table_name . " SET id_penghuni = :id_penghuni, harga_lahan_parkir = :harga_lahan_parkir, jenis_lahan_parkir = :jenis_lahan_parkir, status = :status WHERE nomor_lahan_parkir = :nomor_lahan_parkir";
        $stmt = $this->conn->prepare($query);
